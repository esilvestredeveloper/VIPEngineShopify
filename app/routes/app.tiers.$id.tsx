...
export const loader = async ({ request, params }: LoaderFunctionArgs) => {
  ...
  // Verificar que pertenezca a la tienda actual
  if (tier.shop !== session.shop) {
...
export default function EditTier() {
  ...
  useEffect(() => {
    if (actionData?.success) {
      shopify.toast.show("Nivel actualizado correctamente");
      navigate("/app/tiers");
    }
  ...
  return (
    ...
    >
          ...
          <s-stack direction="block" gap="base">
            ...
            <s-stack direction="block" gap="tight">
              ...
              <s-text-field
                name="minSpent"
                type="number"
                defaultValue={tier.minSpent.toString()}
                placeholder="0.00"
                step="0.01"
                min="0"
                prefix="$"
            ...
            <s-stack direction="block" gap="tight">
              ...
              <s-text-field
                name="minOrders"
                type="number"
                defaultValue={tier.minOrders.toString()}
                placeholder="0"
                step="1"
                min="0"
                autoComplete="off"
            ...
            <s-stack direction="block" gap="tight">
              ...
              <s-text-field
                ...
                type="number"
                defaultValue={tier.discountPercentage.toString()}
                placeholder="0"
                step="0.01"
                min="0"
                max="100"
            ...
            <s-stack direction="block" gap="tight">
              ...
              <s-text-field
                name="priority"
                type="number"
                defaultValue={tier.priority.toString()}
                placeholder="0"
                step="1"
                min="0"
                autoComplete="off"
            ...
            {/* Activo */}
            <s-stack direction="block" gap="tight">
              <s-checkbox name="active" value="true" defaultChecked={tier.active}>
                Nivel activo
              </s-checkbox>
              <s-text tone="subdued">
      ...
      <s-section slot="aside" heading="Información">
        <s-paragraph>
          Puedes modificar cualquier aspecto del nivel. Los cambios se aplicarán a futuras asignaciones automáticas.
        </s-paragraph>
        <s-unordered-list>
          <s-list-item>
            Creado: {new Date(tier.createdAt).toLocaleDateString()}
          </s-list-item>
          <s-list-item>
            Última actualización: {new Date(tier.updatedAt).toLocaleDateString()}
          </s-list-item>
        </s-unordered-list>
      </s-section>
    </s-page>
